...
class ClasificacionService
{
    ...
    private function calcularBonificacionFisico2(?float $yoyo, string $sexo): float
    {
        ...
        if ($sexo === 'FEMENINO') {
            return match ($yoyo) {
                ...
                16.6 => 13.0, 16.7 => 14.0, 
                16.8, 17.1, 17.2, 17.3, 17.4, 17.5, 17.6, 17.7, 17.8,
    ...
    private function calcularBonificacionFisico2_oficiales(?float $yoyo, string $sexo): float
    {
        ...
        if ($sexo === 'FEMENINO') {
            return match ($yoyo) {
                ...
                17.3 => 9.00, 17.4, 17.5, 17.6, 17.7, 17.8, 18.1, 18.2, 18.3, 18.4, 18.5, 
                18.6, 18.7, 18.8, 19.1, 19.2 => 10.00,
    ...
    private function calcularBonificacionFisico3(?float $yoyo, string $sexo): float
    {
        ...
        if ($sexo === 'FEMENINO') {
            return match ($yoyo) {
                ...
                16.8, 17.1, 17.2, 17.3, 17.4, 17.5, 17.6, 17.7,
                17.8, 18.1, 18.2, 18.3, 18.4, 18.5, 18.6, 18.7,
                18.8, 19.1, 19.2 => 7.00,
                default => 0.00
            };
        }
    ...
    private function calcularBonificacionFisico3_oficiales(?float $yoyo, string $sexo): float
    {
        ...
        if ($sexo === 'FEMENINO') {
            return match ($yoyo) {
                ...
                17.3 => 18.00, 17.4, 17.5, 17.6, 17.7, 17.8, 18.1, 18.2, 18.3, 18.4,
                18.5, 18.6, 18.7, 18.8, 19.1, 19.2 => 20.00, 
                default => 0.00
            };
        }
    ...
    private function calcularBonificacionFisico1_auxiliares(?float $yoyo, string $sexo): float
    {
        ...
        if ($sexo === 'MASCULINO') {
            return match ($yoyo) {
                ...
                17.6, 17.7, 17.8, 18.1, 18.2, 18.3, 18.4,
                18.5, 18.6, 18.7, 18.8, 19.1, 19.2 => 25.00,
                default => 0.00
            };
        }
        ...
        if ($sexo === 'FEMENINO') {
            return match ($yoyo) {
                ...
                17.6, 17.7, 17.8, 17.1, 17.2,
                17.3, 17.4, 17.5, 17.6, 17.7,
                17.8, 18.1, 18.2, 18.3, 18.4,
                18.5, 18.6, 18.7, 18.8, 19.1, 19.2 => 25.00, 
                default => 0.00
            };
        }
    ...
    public function generarExcelProvincial (Categorias $categoria): string
    {
        ...
        */
        ...
        // Ajustes de impresión y visualización
    ...
    public function generarExcelOficial (Categorias $categoria): string
    {
        ...
        $sheet->setCellValue("H9", "TÉCNICO 2");

        $sheet->mergeCells("J9:K9");
        $sheet->setCellValue("J9", "FÍSICO 2");

        $sheet->mergeCells("L9:M9");
        $sheet->setCellValue("L9", "TÉCNICO 3");

        $sheet->mergeCells("N9:P9");
        $sheet->setCellValue("N9", "FÍSICO 3");

        $sheet->mergeCells("Q9:R9");
        $sheet->setCellValue("Q9", "CLASES");

        $sheet->mergeCells("S9:U9");
        $sheet->setCellValue("S9", "CARTUJA");

        foreach (['D9', 'F9', 'H9', 'J9', 'L9', 'N9', 'Q9', 'S9'] as $cell) {
            $sheet->getStyle($cell)->applyFromArray([
                'alignment' => [
                    'horizontal' => Alignment::HORIZONTAL_CENTER,
                    'vertical' => Alignment::VERTICAL_CENTER
        ...
        // Estilo general para la fila 9 
        $sheet->getStyle("D9:U9")->applyFromArray([
            'alignment' => [
                'horizontal' => Alignment::HORIZONTAL_CENTER,
                'vertical' => Alignment::VERTICAL_CENTER,
                'wrapText' => false,
        ...
        // Aplicar estilos por bloque de columnas 
        $colores = [
            'A' => 'FFFFFF', 'B' => 'FFFFFF', 'C' => 'FFFFFF',
            'D' => 'E2EFDA', 'E' => 'E2EFDA',
            'F' => 'DDEBF7', 'G' => 'DDEBF7', 
            ...
            'J' => 'E6E1F9', 'K' => 'E6E1F9',
            'L' => 'FCE4D6', 'M' => 'FCE4D6',
            'N' => 'D9E1F2', 'O' => 'D9E1F2', 'P' => 'D9E1F2',
            'Q' => 'CCFFCC', 'R' => 'CCFFCC', 
            'S' => 'FFCCCC', 'T' => 'FFCCCC', 'U' => 'FFCCCC',
            'V' => 'FFFFFF', 'W' => 'FFFFFF', 'X' => 'FFFFFF', 'Z' => 'FFFFFF'
        ];
        ...
        foreach ($datos as $dato) {
            ...
            //Formato a los números de la tabla
            foreach ([
                'E'  => '0.00', // Bonificación T1
                'F'  => '0.0',  // Yoyo F1
                'G'  => '0.00', // Bono F1
            ...
            // Tamaño de letra 9 pt en cada fila desde la 11
           $sheet->getStyle("A{$rowIndex}:Y{$rowIndex}")
            ->getFont()
            ->setSize(9);
        ...
        //Bloques para borde exterior medio grueso
        $bloques = [
            'A9:A'   . $lastRow,
            'B9:B'   . $lastRow,
            'C9:C'   . $lastRow,
        ...
        //Separador de columnas dentro de bloques discontinuo
        $columnasDiscontinuas = [
            'D', 'F', 'H', 'J', 'L', 'N', 'O', 'Q', 'S', 'T'
        ];
        ...
        //Color de fondo de filas impares
        for ($fila = 11; $fila <= $lastRow; $fila++) {
            if ($fila % 2 !== 0) { // Solo filas impares
                $sheet->getStyle("A{$fila}:Y{$fila}")->getFill()->setFillType(Fill::FILL_SOLID);
                $sheet->getStyle("A{$fila}:Y{$fila}")->getFill()->getStartColor()->setRGB('F5F5F5');
            }
        }
        ...
        $columns = [];
        $col = 'A';
        while ($col !== 'Z') { // 'Z' es la columna siguiente a 'Y'
            $columns[] = $col;
            $col++;
        }
        ...
        $sheet->setCellValue('Q1', 'LEYENDA OBSERVACIONES');
        ...
        $sheet->setCellValue('Q2', 'NO APTO ASCENSO');
        ...
        foreach ($leyenda as $texto) {
            ...
            $sheet->setCellValue("Q{$row}", $texto); 
        ...
        // Borde al cuadro completo de leyenda
        $sheet->getStyle('Q1:Y6')->applyFromArray([
            'borders' => [
                'outline' => [
                    'borderStyle' => Border::BORDER_HAIR,
                    'color' => ['argb' => 'FF000000']
    ...
    public function generarExcelAuxiliar (Categorias $categoria): string
    {
        ...
        $sheet->mergeCells("F9:G9");
        $sheet->setCellValue("F9", "TÉCNICO 2");

        $sheet->mergeCells("H9:I9");
        $sheet->setCellValue("H9", "TÉCNICO 3");

        $sheet->mergeCells("J9:K9");
        $sheet->setCellValue("J9", "FÍSICO 1");

        $sheet->mergeCells("L9:M9");
        $sheet->setCellValue("L9", "CLASES");

        foreach (['D9', 'F9', 'H9', 'J9', 'L9'] as $cell) {
            $sheet->getStyle($cell)->applyFromArray([
                'alignment' => [
                    'horizontal' => Alignment::HORIZONTAL_CENTER,
                    'vertical' => Alignment::VERTICAL_CENTER
        ...
        // Estilo general para la fila 9 
        $sheet->getStyle("D9:M9")->applyFromArray([
            'alignment' => [
                'horizontal' => Alignment::HORIZONTAL_CENTER,
                'vertical' => Alignment::VERTICAL_CENTER,
                'wrapText' => false,
        ...
        $colores = [
            'A' => 'FFFFFF', 'B' => 'FFFFFF', 'C' => 'FFFFFF',
            'D' => 'E2EFDA', 'E' => 'E2EFDA', // TÉCNICO 1
            'F' => 'FFF2CC', 'G' => 'FFF2CC', // TÉCNICO 2
            'H' => 'FCE4D6', 'I' => 'FCE4D6', // TECNICO 3
            'J' => 'D9E1F2', 'K' => 'D9E1F2', // FISICO 1
            'L' => 'CCFFCC', 'M' => 'CCFFCC', // CLASES
            'N' => 'FFFFFF', 'O' => 'FFFFFF', 'P' => 'FFFFFF', 'Q' => 'FFFFFF'
        ];
        ...
        foreach ($datos as $dato) {
            ...
            // Tamaño de letra 9 pt en cada fila desde la 11
           $sheet->getStyle("A{$rowIndex}:Q{$rowIndex}")
            ->getFont()
            ->setSize(9);
        ...
        for ($fila = 11; $fila <= $lastRow; $fila++) {
            if ($fila % 2 !== 0) { // Solo filas impares
                $sheet->getStyle("A{$fila}:Q{$fila}")->getFill()->setFillType(Fill::FILL_SOLID);
                $sheet->getStyle("A{$fila}:Q{$fila}")->getFill()->getStartColor()->setRGB('F5F5F5');
            }
        }
        ...
        $columns = [];
        $col = 'A';
        while ($col !== 'R') { // 'R' es la columna siguiente a 'Q'
            $columns[] = $col;
            $col++;
        }
        ...
        $sheet->setCellValue('J1', 'LEYENDA OBSERVACIONES');
        ...
        $sheet->setCellValue('J2', 'NO APTO ASCENSO');
        ...
        $leyenda = [
            ' (1) No temporada completa',
            ' (2) Mínimo Clases / prácticas',
            ' (3) Exámen técnico',
            ' (4) Pruebas físicas'
        ];
        ...
        $row = 3;
        foreach ($leyenda as $texto) {
            $sheet->mergeCells("J{$row}:Q{$row}");
            $sheet->setCellValue("J{$row}", $texto); 
        ...
        // Borde al cuadro completo de leyenda
        $sheet->getStyle('J1:Q6')->applyFromArray([
            'borders' => [
                'outline' => [
                    'borderStyle' => Border::BORDER_HAIR,
                    'color' => ['argb' => 'FF000000']
