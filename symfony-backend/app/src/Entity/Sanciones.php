...
#[ORM\Entity(repositoryClass: SancionesRepository::class)]
class Sanciones
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    public function getArbitro(): Arbitros { return $this->arbitro; }
    public function setArbitro(Arbitros $arbitro): self {
        $this->arbitro = $arbitro;
        return $this;
    }

    public function getCategoria(): Categorias { return $this->categoria; }
